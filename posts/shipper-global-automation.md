...
השתמשתי ב-Mailhook שקולט את אישור המשלוח שמגיע מ-Shipper Global. האתגר הטכני: המידע במייל מגיע בפורמט לא מסודר. בעזרת Claude Code כתבתי סקריפט PHP קטן שיושב על השרת שלנו, מנקה את הטקסט, ושולף את קוד המעקב בצורה נקייה כדי לעדכן את החנות דרך ה-API.
